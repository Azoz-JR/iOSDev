...
struct RecipeForm: View {
    ...
    func saveRecipe() {
        let newRecipe = Recipe(id: UUID(), name: recipeName, imageURL: recipeImageURL, category: category.rawValue, ingredients: ingredients.components(separatedBy: .newlines), instructions: instructions.components(separatedBy: .newlines))
